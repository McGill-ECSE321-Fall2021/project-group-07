...
public class LibrarySystem07Controller {
	...
	throws IllegalArgumentException {
		...
		HeadLibrarian hldto = service.getHeadLibrarian(headLibrarian.getLibraryCardID());
		HeadLibrarianTimeSlot headLibrarianTimeSlot = service.createHeadLibrarianTimeSlot(hldto, Time.valueOf(startTime), Time.valueOf(endTime), weekDay);
